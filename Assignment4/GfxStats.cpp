...
void GfxStats::setTexturing(bool value)
{
	m_Texturing = value ? "On" : "Off";
}

void GfxStats::setEnvironmentMap(bool value)
{
	m_EnvironmentMap = value ? "On" : "Off";
}

void GfxStats::setNormalMap(bool value)
{
	m_NormalMap = value ? "On" : "Off";
}

void GfxStats::setShininess(FLOAT value)
{
	m_Shininess = value;
}

void GfxStats::setEnvMapStr(FLOAT value)
{
	m_EnvMapStr = value;
}

void GfxStats::setNormalMapStr(FLOAT value)
{
	m_NormalMapStr = value;
}
